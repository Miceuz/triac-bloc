...
x = np.loadtxt("zc-pulse-filtered", delimiter=",")
N = x.shape[0]
...
plt.title("Zero crossing pulse length, R input = 32.8k, R pullup = 47k")
plt.savefig("Zero crossing pulse length, R input = 32k8, R pullup = 47k")
plt.figure()
...
plt.title("Zero crossing pulse length FFT, R input = 32.8k R pullup = 47k")
plt.savefig("Zero crossing pulse length FFT, R input = 32k8 R pullup = 47k")
plt.figure()
...
plt.title("Pulse length differeces for adjacent pulses, R input = 32.8k R pullup = 47k")
plt.savefig("Pulse length differeces for adjacent pulses, R input = 32k8 R pullup = 47k")
plt.show()
