...
plt.title("Zero crossing pulse length, R input = 32.8k, R pullup = 10k")
plt.savefig("Zero crossing pulse length, R input = 32k8, R pullup = 10k")
plt.figure()
...
plt.title("Zero crossing pulse length FFT, R input = 32.8k R pullup = 10k")
plt.savefig("Zero crossing pulse length FFT, R input = 32k8 R pullup = 10k")
plt.figure()
...
plt.title("Pulse length differeces for adjacent pulses, R input = 32.8k R pullup = 10k")
plt.savefig("Pulse length differeces for adjacent pulses, R input = 32k8 R pullup = 10k")
plt.show()
